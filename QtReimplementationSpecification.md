...
- Linux AppImage production workflows that use Qt's CMake deployment API shall build the portable artifact with a Qt version that supports Linux deployment through that API, and shall record the Qt source, version, and selected archive set in release provenance
