...
- For selected editable line vertices, the `Point / Vertex` section shall expose insert-vertex and delete-vertex actions using the same source rewrite behavior as the corresponding keyboard commands.
