...
- The `Selection` inspector shall group controls into a selected-object section, `Point / Vertex`, `Geometry`, and `Actions` sections so object-level edits, point/vertex actions, geometry state controls, and object actions remain visually distinct.
