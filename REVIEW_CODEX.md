...
- `TherionDocumentEditor::appendDraftGeometry()`, `appendDraftLineGeometry()`, and `appendDraftAreaGeometry()` now insert generated draft geometry through lossless physical source-line insertion instead of split/join full-document reconstruction.
