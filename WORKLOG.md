...
- P1 - Inspector layout consistency: keep Selection/Objects/Backgrounds, Context Help, and Block inspector sidebars visually consistent with pre-regression panel styling while preserving robust small-height scrolling behavior (no nested panel background bleed, no accidental palette overrides).
