...
- P1: Continue Phase 3 map command alignment by migrating remaining map canvas/source operations (vertex insert/split/remove/smooth/control-handle flows) to explicit transaction requests with one-operation undo semantics.
