...
- P1: Continue Phase 3 map command alignment by migrating remaining non-vertex map inspector/source operations (remaining draft/object workflows outside completed inspector/object-details slices) to explicit transaction requests with one-operation undo semantics and policy-driven restore hooks.
