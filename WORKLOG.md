...
- P1 - Validation and catalog metadata: keep validation conservative while moving command/option interpretation into catalog-backed logical-command metadata and toward live project diagnostics; project validation scheduling now routes through a controller boundary and suppresses stale scan results when a newer scan request is queued.
