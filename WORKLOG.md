...
- P1: Continue Phase 2 delegate reduction by removing remaining direct `TextEditorTab` source rewrite delegate usage from controller-level map flows, primarily in interactive-draw contexts after inspector-object and object-details callback unification.
