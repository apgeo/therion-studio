...
- P1: Continue Phase 4 remaining-adopter routing after the latest mode-normalization migration, focusing on project/sidebar source mutations still outside the shared transaction request path.
