...
- P1: Continue Phase 3 map command alignment by migrating remaining non-vertex map canvas/source operations to explicit transaction requests with one-operation undo semantics and policy-driven restore hooks.
