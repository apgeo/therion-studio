...
- P1: Continue Phase 4 remaining-adopter routing after Raw validation-fix migration, focusing on remaining Raw command and project/sidebar source mutations still outside the shared transaction request path.
