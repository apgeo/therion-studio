...
- Slice 2 - Continue expanding `TherionSourceSnapshotCache` through Structure/project-index consumers now that
  project validation scanner text validation and source-reference checks share scanner-local source snapshots.
