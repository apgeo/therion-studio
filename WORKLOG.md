...
- P1: Continue the unified transaction model by aligning remaining map canvas/source command flows on transaction requests with explicit stale-edit handling and shared refresh/selection restore behavior.
