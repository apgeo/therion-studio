...
- Slice 2 - Continue converging shared source projections at core entry points now that app-side validation,
  project-index, and raw completion/context consumers route logical document creation through `TherionSourceSnapshotCache`.
