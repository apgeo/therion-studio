...
- P1 - Validation and catalog metadata: keep validation conservative while moving command/option interpretation into catalog-backed logical-command metadata and toward live project diagnostics; project validation scheduling now routes through a controller boundary, suppresses stale scan results, and refreshes non-intrusively after project open.
