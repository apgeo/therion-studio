...
- ~~Moved the Homebrew formula out of this repository to the dedicated tap repository (`ladislavb/homebrew-therion-studio`) and updated local docs/install references to point to the tap.~~
