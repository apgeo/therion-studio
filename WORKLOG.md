...
- Linux AppImage packaging depends on Debian 13 distro Qt, Qt's Linux deploy script, and pinned `appimagetool`/runtime inputs; verify the full path in GitHub Actions on Ubuntu 26.04 and Debian 13 before treating it as stable.
