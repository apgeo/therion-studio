...
- P1: Continue Phase 3 map command alignment by migrating remaining non-vertex map inspector/source operations (object settings/scrap edits and remaining draft/object workflows) to explicit transaction requests with one-operation undo semantics and policy-driven restore hooks.
