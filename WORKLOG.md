...
- P1 - Project index hardening: evolve the current structure sidebar scanner into a core `ProjectIndexSnapshot` with reusable object/reference data, keep map-to-scrap reference resolution outside UI widgets, and continue toward stable object IDs, diagnostics, and compiler-confirmed snapshots.
...
- P1: Continue ProjectIndex hardening with stable object IDs, unresolved-reference diagnostics, and `thconfig source/endsource` file graph coverage.
