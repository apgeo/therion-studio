...
- P1 - Test infrastructure hygiene: use QTest for all new C++ tests while keeping CTest as the runner, migrate existing hand-rolled test files incrementally when touched, and consolidate small test executables only where their dependency and runtime boundaries already match.
