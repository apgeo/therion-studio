...
- Phase 11: continue structured block-canvas authoring coverage after first-class `map` body `Object Reference` pseudo-block rendering/insertion/edit/reorder support and generated catalog-backed `break` availability in `Inside Map`, safer nested insertion behavior, and remaining BlockEditor extraction/refactor slices.
