...
- P1 - Map editor parity: continue XTherion-aligned selection, context menus, panning, Bezier input, Smart Area, TH2 source sync, robust standalone slope line-point metadata parsing (`l-size`/`orientation`), and the guardrail that project validation diagnostics must not perturb map canvas selection/drag/draw workflows.
